...
plotDir         = os.path.expandvars(('/afs/cern.ch/user/' + userGroup + '/$USER/www/TTTT/')       if 'lxp' in socket.gethostname() else '/user/$USER/public_html/TTTT/')
plotCombineDir         = os.path.expandvars(('/afs/cern.ch/user/' + userGroup + '/$USER/www/TTTT/')       if 'lxp' in socket.gethostname() else '/user/$USER/public_html/TTTT/')
...
reducedTupleDir = os.path.expandvars('/pnfs/iihe/cms/store/user/$USER/4TTuples/')
