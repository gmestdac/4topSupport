...
outFile = open(os.path.expandvars('$CMSSW_BASE/src/topSupport/samples/data/tuples_comb.conf'),"w")
outFile.write('%WARNING: This file gets overwritten by combSamples.py, edit the tuples_year files instead')
for year in ['2016', '2017', '2018']:
  outFile.write('\n\n%----------------- ' + year + ' samples -----------------\n\n')
  inFile = open(os.path.expandvars('$CMSSW_BASE/src/topSupport/samples/data/tuples_' + year + '.conf'), 'r')
