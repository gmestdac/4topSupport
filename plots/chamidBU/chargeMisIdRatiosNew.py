...
l1RPath = '/storage_mnt/storage/user/gmestdac/public_html/TTTT/YEAR/hpe-onlyPROC-norat-newVER/ee/SEL-l1NCF/'
l1WPath = '/storage_mnt/storage/user/gmestdac/public_html/TTTT/YEAR/hpe-onlyPROC-norat-newVER/ee/SEL-l1CF/'
l2RPath = '/storage_mnt/storage/user/gmestdac/public_html/TTTT/YEAR/hpe-onlyPROC-norat-newVER/ee/SEL-l2NCF/'
l2WPath = '/storage_mnt/storage/user/gmestdac/public_html/TTTT/YEAR/hpe-onlyPROC-norat-newVER/ee/SEL-l2CF/'
      ...
      for proc in ['DYpile', 'TTpile'] + ([i + p for i in ['DYpile'] for p in ['Pre', 'Post']] if year == '2016' else []):
        ...
        for sel in ['onZ-nLep2-lepsPrompt']:
          try:
            ...
            ratio.SaveAs('chamidRat' + ver +'/chamid_' + year + '_' + proc + '_' + sel + '_' + plot + '.root')
            

            pickle.dump(ratio, file('chamidRat' + ver +'/chamid_' + year + '_' + proc + '_' + sel + '_' + plot + '.pkl', 'w'))
            ...
            canv.SaveAs('chamidRat' + ver +'/chamid_' + year + '_' + proc + '_' + sel + '_' + plot + '.pdf')
